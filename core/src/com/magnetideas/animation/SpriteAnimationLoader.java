package com.magnetideas.animation;
...
import com.magnetideas.animation.SpriteAnimationData;
...
public class SpriteAnimationLoader extends AsynchronousAssetLoader<SpriteAnimationData, SpriteAnimationLoader.AnimationParameter> 
{
	...
	static public class AnimationParameter extends
			AssetLoaderParameters<SpriteAnimationData> {
	}
	...
	/**
	 * Retrieves the animation data as it is (without loading anything, this is
	...
	/**
	 * Gets animation data dependencies, this is, the spreadsheet texture to
	 * load
	 */
	@Override
