 ...
 * @class AnimationData
 *
 * @brief Holds animation frame sequences and reads them from JSON files and a
 *        spritesheet-like texture
 *
...
public class SpriteAnimationData {
	...
	/**
	 * @param animationName
	 *  name of the desired animation
	 * @return animation object containing the sequence of frames, null if not
	 * found
	 */
	public Animation getAnimation(String animationName) 
	{
		...
		if (animation == null) {
			Gdx.app.log("SpriteAnimationData", "Animation: " + animationName
