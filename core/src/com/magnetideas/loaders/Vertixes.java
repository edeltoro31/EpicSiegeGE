...
public class Vertixes {
	...
	//--Constants--//
	   ...
	   public Vertixes(GL20 gl, int maxVertices, int maxIndices, boolean hasColor, boolean hasTexCoords, boolean hasNormals)  {
	      this( gl, maxVertices, maxIndices, hasColor, hasTexCoords, hasNormals, true );  // Call Overloaded Constructor
	   }
	   public Vertixes(GL20 gl, int maxVertices, int maxIndices, boolean hasColor, boolean hasTexCoords, boolean hasNormals, boolean use3D)  {
