...
import com.magnetideas.parallax.ParallaxLayer.TileMode;
...
public class ParallaxBackground {
     ...
     */
    public void draw(MyOrthographicCamera worldCamera, Batch batch) {
        ...
        worldCamera.setPosition(cachedPos);
        //worldCamera.zoom = cachedZoom;
        worldCamera.setZoom(cachedZoom);
        worldCamera.update();
        batch.setProjectionMatrix(worldCamera.combined);
